...
export function ManageUsersContent({ user, created_at }: {
    ...
    return (<div className="w-fit h-[72px] border border-bd-gray grid grid-cols-[174px_270px_240px_140px_135px_115px_80px]">
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">{user.user_id}</div>
        <UserCard src={user.src} firstname={user.firstname} lastname={user.lastname} />
        <div className="flex text-body-bold text-standard-gray pt-[1px] pl-[16px] pr-[16px] justify-between items-center">{user.email}</div>
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">{created_at}</div>
...
export function ViewReportsContent({ id, reported_user, reporter_user, created_at, report_type }: {
    ...
    return (<div className="w-fit h-[72px] border border-bd-gray grid grid-cols-[174px_270px_270px_140px_220px_80px]">
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">{id}</div>
        ...
        <div className="flex text-body-bold text-standard-gray pt-[1px] pl-[16px] pr-[16px] justify-between items-center">{created_at}</div>
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-center items-center"><Report report_type={report_type} /></div>
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">Action</div>
    </div>);
}
...
export function ViewApplicationsContent({ id, user, created_at }: {
    ...
    return (<div className="w-fit h-[72px] border border-bd-gray grid grid-cols-[174px_270px_270px_220px_140px_80px]">
        ...
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">{user.email}</div>
        <div className="flex text-body-bold text-standard-gray pt-[1px] pl-[16px] pr-[16px] justify-between items-center">{user.phone}</div>
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">{created_at}</div>
        <div className="flex text-body-bold text-standard-gray pl-[16px] pr-[16px] justify-between items-center">Action</div>
    </div>);
}
