...
export function ManageUsersContent({ user, created_at }: {
    ...
    return (<div className="w-fit h-[72px] border border-t-0 border-bd-gray grid grid-cols-[174px_270px_240px_140px_135px_115px_80px]">
...
export function ViewReportsContent({ id, reported_user, reporter_user, created_at, report_type }: {
    ...
    return (<div className="w-fit h-[72px] border border-t-0 border-bd-gray grid grid-cols-[174px_270px_270px_140px_220px_80px]">
...
export function ViewApplicationsContent({ id, user, created_at }: {
    ...
    return (<div className="w-fit h-[72px] border border-t-0 border-bd-gray grid grid-cols-[174px_270px_270px_220px_140px_80px]">
        <div className="flex text-body text-standard-gray pl-[16px] pr-[16px] justify-between items-center">{id}</div>
